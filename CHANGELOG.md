...
- **Amazon Prime Video Detection**: New Prime Video region unlock detection support

### Changed

- **Temporary File Security**: Use `mktemp` to create secure temporary files
- **Empty Input Handling**: Improved user experience when pressing Enter without input
- **Code Refactoring**: Extract `MIN_COOKIE_LENGTH` constant for better maintainability
